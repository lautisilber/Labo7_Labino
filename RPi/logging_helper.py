...
rotating_handler_info.addFilter(LoggingLevelFilter(logging.INFO))
...
rotating_handler_error.addFilter(LoggingLevelFilter((logging.WARNING, logging.ERROR, logging.CRITICAL)))
