...
// copied from https://github.com/boschsensortec/BME280_SensorAPI/blob/master/examples/common/common.c
...
{
    i2c_dev = i2c;
    uint actual_baudrate = i2c_init(i2c_dev, baudrate);
    return baudrate == actual_baudrate;
}
 ...
 *  @retval < 0 -> Failure
 */
static int8_t bme280_interface_selection(struct bme280_dev *dev, uint8_t intf)
{
